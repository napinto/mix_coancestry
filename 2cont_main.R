...
openxlsx::write.xlsx(x = summary_stats_all_markers,file = "2cont_summary_stats.xlsx")
...
#results_per_mixture[1:10,] %>% openxlsx::write.xlsx(x = .,file = "2cont_results_per_mixture_10.xlsx")
...
openxlsx::write.xlsx(x = summary_stats_per_mixture,file = "2cont_summary_stats_per_mixture.xlsx")
...
by_case_type_by_marker %>% openxlsx::write.xlsx(x = .,file = "2cont_by_case_type_by_marker.xlsx")
